...
exports.JsonResumeSchemaSchema = {
...
exports.isJsonResumeSchema = exports.ajv.compile(exports.JsonResumeSchemaSchema);
function validate(value) {
    if (exports.isJsonResumeSchema(value)) {
        return value;
    }
    else {
        throw new Error(exports.ajv.errorsText(exports.isJsonResumeSchema.errors.filter(function (e) { return e.keyword !== "if"; }), { dataVar: "JsonResumeSchema" }) +
            "\n\n" +
